...
public class ExException {
	...
	private static final String CONST_TASK_INPUT_NAME = "以下の例外を発生させるためのパラメーター（1〜3）のいずれかを入力してください。\n・1: NullPointerException\n・2: ArrayIndexOutOfBoundsException\n・3: ClassCastException";
	private static final String CONST_COMMON_MSG_ERROR_EXCEPTION = "エラー: 入力値が不正です。";
	private static final String CONST_MSG_NOT_EXCEPTION_TRIGER = "例外の発生しないパラメーターです。";
	...
	public static void main(String args[]) {
		...
		try {
			...
			System.out.println(CONST_TASK_INPUT_NAME);
			...
			case CONST_EXCEPTION_TRIGER_CAST:
				...
				break;
			default:
				System.out.println(CONST_MSG_NOT_EXCEPTION_TRIGER);
				break;
			}
